  ...
  var flowStatsWidget = {
    ...
    intializeD3:function (scope,element){
      ...
      scope.line    = d3.svg.line()
        ...
        return scope.y(d);});
      scope.path    = scope.svg.append('svg:path')
                        .attr('class','dataLine')
                        .data([data])
                        .attr('d', scope.line)
                        .attr('fill', 'none')
...
*/
  ...
  function iibWidgetDirective($rootScope,iibSubscriber){
  ...
  function iibFlowStatsDirective($rootScope,iibSubscriber){
    var iibSubscriber=iibSubscriber;
    return {
      restrict: 'AC',
